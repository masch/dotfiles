...
augroup go
  ...
  autocmd FileType go nmap <silent> <Leader>u <Plug>(go-implements)

  autocmd FileType go nmap <silent> <leader>b :<C-u>call <SID>build_go_files()<CR>

  autocmd FileType go nmap <silent> <leader>G  <Plug>(go-test-func)
  autocmd FileType go nmap <silent> <leader>g  <Plug>(go-test-last-func)
...
" search 
nmap <C-h> :FzfHistory<cr>
imap <C-h> <esc>:<C-h>FzfHistory<cr>

" search across files in the initial directory
